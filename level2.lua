...
Level Intention: Level 2 is an introduction to controls and goals. 
...
local function createWalls () 
  -- right walls
  horizontal_wall_group:insert( rWall( board[12], board[5] ))
  horizontal_wall_group:insert( rWall( board[12], board[6] ))
  horizontal_wall_group:insert( rWall( board[12], board[7] ))

  -- left walls
  horizontal_wall_group:insert( lWall( board[4], board[5] ))
  horizontal_wall_group:insert( lWall( board[4], board[6] ))
  horizontal_wall_group:insert( lWall( board[4], board[7] ))

  -- bottom walls
  vertical_wall_group:insert( bWall( board[4], board[7] ))
  vertical_wall_group:insert( bWall( board[5], board[7] ))
  vertical_wall_group:insert( bWall( board[6], board[7] ))
  vertical_wall_group:insert( bWall( board[7], board[7] ))
  vertical_wall_group:insert( bWall( board[8], board[7] ))
  vertical_wall_group:insert( bWall( board[9], board[7] ))
  vertical_wall_group:insert( bWall( board[10], board[7] ))
  vertical_wall_group:insert( bWall( board[11], board[7] ))
  vertical_wall_group:insert( bWall( board[12], board[7] ))
  -- vertical_wall_group:insert( bWall( board[13], board[7] ))

  -- top walls
  vertical_wall_group:insert( tWall( board[4], board[5] ))
  vertical_wall_group:insert( tWall( board[5], board[5] ))
  vertical_wall_group:insert( tWall( board[6], board[5] ))
  vertical_wall_group:insert( tWall( board[7], board[5] ))
  vertical_wall_group:insert( tWall( board[8], board[5] ))
  vertical_wall_group:insert( tWall( board[9], board[5] ))
  vertical_wall_group:insert( tWall( board[10], board[5] ))
  vertical_wall_group:insert( tWall( board[11], board[5] ))
  vertical_wall_group:insert( tWall( board[12], board[5] ))
  -- vertical_wall_group:insert( tWall( board[13], board[5] ))
...
local function createBlocks ()
  red_group:insert( rBlock( board[4], board[5] ))
  red_group:insert( rBlock( board[8], board[6] ))
  red_group:insert( rBlock( board[12], board[7] ))
